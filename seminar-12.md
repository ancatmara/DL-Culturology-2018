...
Откроем программу и перетащим видео в окно. В верхнем меню выберем _Линия времени_. В меню таймлайна выберем _Добавить видеодорожку_. Теперь, с помощью ползунков под видео выделим кусок видео, в меню таймлафна нажмём на плюс – выделенный кусок добавится на дорожку. 

![](/assets/rgfedsaimport.png)

Добавим на ту же дорожку кусок из другого видео:

![](/assets/grfdsimport.png)
